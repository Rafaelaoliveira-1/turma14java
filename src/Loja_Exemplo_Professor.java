...
public class Loja_Exemplo_Professor {
	...
	public static void main(String[] args) {
		...
		String produtos[] = { "CAIXA PORTA JOIAS", "GUIRLANDA DE NATAL AFRO", "KIT PORTA COPOS", "CAIXA PORTA TRECO",
				"CAIXA PORTA ARGOLAS", "PORTA-RELOGIOS", "QUADRO AFRO", "ESPELHO DE YANSÃ", "KIT PORTA-COPOS LUXO",
				"QUADRO SIMPLES" };
